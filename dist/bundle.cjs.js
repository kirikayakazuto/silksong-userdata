...
const ecb = new aesJsExports.ModeOfOperation.ecb(aesKey);
...
function AddGeoAndShellShardsNumber(jsonObj, geoNumber, shellShardsNumber) {
...
function PrintGeoAndShellShardsNumber(jsonObj) {
    let playerdata = jsonObj['playerData'];
    if(!playerdata) {
        console.log("没找到玩家数据, 请联系作者");
        return
